...
public class SysOrderDTO extends SysOrderKey implements Serializable {
    ...
    private List<SysOrderDetail> sysOrderDetails = new ArrayList<>();

    @ApiModelProperty(value = "对应包裹")
    private List<SysOrderPackageDTO> packages = new ArrayList<SysOrderPackageDTO>(){{add(new SysOrderPackageDTO());}};
    ...
    @ApiModelProperty(value = "是否可以转入，1可转入，2不可转入")
    private Byte convertible;
    ...
    public Byte getConvertible() {
        return convertible;
    }

    public void setConvertible(Byte convertible) {
    ...
    public List<SysOrderPackageDTO> getPackages() {
        return packages;
    }

    public void setPackages(List<SysOrderPackageDTO> packages) {
