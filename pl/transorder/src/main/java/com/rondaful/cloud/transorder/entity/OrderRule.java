...
public class OrderRule implements Serializable {
    ...
    @ApiModelProperty(value = "邮寄方式CODE(分配邮寄方式时使用此字段)")
    ...
    public String getEffectiveStartTime() {
        return StringUtils.isEmpty(effectiveStartTime)?null:effectiveStartTime;
    }
    ...
    public String getEffectiveEndTime() {
        return StringUtils.isEmpty(effectiveEndTime)?null:effectiveEndTime;
    }
