...
public class SysOrderPackageDTO implements Serializable {
    ...
    private List<SysOrderPackageDetail> sysOrderPackageDetails = new ArrayList<>();
    ...
    public List<SysOrderPackageDetail> getSysOrderPackageDetails() {
        return sysOrderPackageDetails;
    }

    public void setSysOrderPackageDetails(List<SysOrderPackageDetail> sysOrderPackageDetails) {
        this.sysOrderPackageDetails = sysOrderPackageDetails;
    }
