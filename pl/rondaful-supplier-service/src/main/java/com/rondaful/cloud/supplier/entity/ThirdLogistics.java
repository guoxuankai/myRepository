 ...
 */
@ApiModel(value ="thirdLogistics")
public class ThirdLogistics implements Serializable {
	...
	public String toString() {
		return "ThirdLogistics [id=" + id + ", ebayCarrier=" + ebayCarrier + ", amazonCarrier=" + amazonCarrier
