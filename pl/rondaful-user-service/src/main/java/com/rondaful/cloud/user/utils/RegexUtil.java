 ...
 *
 * @author LittleLiu
 *         Email 1142120950@qq.com
 *         create 2017-10-11 14:11
 */
...
//        System.out.println(NumberUtils.toInt("-0000000002"));
        ...
        System.out.println(isEmail("18475452065@163.com"));
        System.out.println(isPhone("18475452065"));
    }
     ...
     * @return
     */
    public static boolean match01(String username,String password,String mobile,String phone, String email) {
    	
    	//用户名：以字母开头，数字结束  15位    
    	//密码：以字母开头，长度在6-12之间，只能包含字符、数字和下划线。  
    	//手机：现在只有13、15和18开头的11位手机号码。以1开头，第2位数字为3或5或8   后面9位数字
    	//座机：3到4位区号   加-杠     后面  7到9位数字   以数字结尾
    	
    	if(isUsername(username) && isPwd(password) && isPhone(phone) && isMobile(mobile) && isEmail(email)) {
    		return true;
    	}
		return false;
    }
     ...
     * @return
     */
    public static boolean match02(String phone, String password) {
    	
    	//用户名：以字母开头，数字结束  15位
    	//密码：以字母开头，长度在6-12之间，只能包含字符、数字和下划线。
    	//手机：现在只有13、15和18开头的11位手机号码。以1开头，第2位数字为3或5或8   后面9位数字
    	//座机：3到4位区号   加-杠     后面  7到9位数字   以数字结尾
    	if(isPwd(password) && isPhone(phone)) {
    		return true;
    	}
		return false;
    }
     ...
     * @return
     */
    public static boolean match03(String email, String password) {
    	
    	//用户名：以字母开头，数字结束  15位
    	//密码：以字母开头，长度在6-12之间，只能包含字符、数字和下划线。
    	//手机：现在只有13、15和18开头的11位手机号码。以1开头，第2位数字为3或5或8   后面9位数字
    	//座机：3到4位区号   加-杠     后面  7到9位数字   以数字结尾
    	if(isPwd(password) && isEmail(email)) {
    		return true;
    	}
		return false;
    }
	...
	public final static boolean isUsername(String str) {
        return match(str, "^[a-zA-Z]{1}[a-zA-Z0-9_]{3,15}$");
    }
    ...
    public final static boolean isPwd(String str) {
        return match(str, "^[a-zA-Z]\\w{8,16}$");
    }
    ...
    public final static boolean isEmail(String str) {
        return match(str, "^([a-z0-9A-Z]+[-|\\\\.]?)+[a-z0-9A-Z]@([a-z0-9A-Z]+(-[a-z0-9A-Z]+)?\\\\.)+[a-zA-Z]{2,}$");
    }
    ...
    public final static boolean isPhone(String text) {
        ...
        return match(text, "^((17[0-9])|(14[0-9])|(12[0-9])|(16[0-9])|(19[0-9])|(13[0-9])|(15[^4,\\\\D])|(18[1-9]))\\\\d{8}$");
    }
