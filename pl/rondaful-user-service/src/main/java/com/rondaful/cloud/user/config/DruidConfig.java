package com.rondaful.cloud.user.config;
...
@Configuration
@MapperScan(basePackages = {"com.rondaful.cloud.user.mapper","com.rondaful.cloud.user.storage.mapper"}, sqlSessionTemplateRef = "userSqlSessionTemplate")
public class DruidConfig {

    private static final int TX_METHOD_TIMEOUT = 5;//事务超时（秒）

    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.rondaful.cloud.user..service.*.*(..))";//事务切面
