package com.rondaful.cloud.user.common;
...
public class  ResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    @ResponseBody
    public Object handle(GlobalException e){
        try {
            JsonConfig jsonConfig = new JsonConfig();
            JSONObject json = JSONObject.fromObject(new Result(e.getErrorCode(), Utils.i18n(e.getMessage())),jsonConfig);
            Utils.print(json);
