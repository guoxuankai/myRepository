...
@Configuration
@MapperScan(basePackages = "com.rondaful.cloud.order.seller", sqlSessionTemplateRef = "sellerSqlSessionTemplate")
public class SellerDruidConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("sellerDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:seller/*.xml"));
