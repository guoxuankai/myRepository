...
import com.amazonservices.mws.uploadData.common.mws.*;
...
public class RequestReportSample {
    ...
    public static void main(String... args) {
        ...
        final String appName = KeyValueConts.appName;
         ...
         ***********************************************************************/
        final String merchantId = KeyValueConts.merchantId;
        final String sellerDevAuthToken = "X3gzr71Xt9paNbGTruO/WrEXl+FsBUTGLuF/BBn/";
		...
		XMLGregorianCalendar startDate = df
				.newXMLGregorianCalendar(new GregorianCalendar(2017, 12, 12));
