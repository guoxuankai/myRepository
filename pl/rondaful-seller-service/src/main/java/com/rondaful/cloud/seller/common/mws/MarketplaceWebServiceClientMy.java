...
import com.rondaful.cloud.seller.common.mws.model.CancelFeedSubmissionsRequest;
import com.rondaful.cloud.seller.common.mws.model.CancelFeedSubmissionsResponse;
import com.rondaful.cloud.seller.common.mws.model.CancelReportRequestsRequest;
import com.rondaful.cloud.seller.common.mws.model.CancelReportRequestsResponse;
import com.rondaful.cloud.seller.common.mws.model.ErrorResponse;
import com.rondaful.cloud.seller.common.mws.model.GetFeedSubmissionCountRequest;
import com.rondaful.cloud.seller.common.mws.model.GetFeedSubmissionCountResponse;
import com.rondaful.cloud.seller.common.mws.model.GetFeedSubmissionListByNextTokenRequest;
import com.rondaful.cloud.seller.common.mws.model.GetFeedSubmissionListByNextTokenResponse;
...
import com.rondaful.cloud.seller.common.mws.model.GetFeedSubmissionResultResponse;
import com.rondaful.cloud.seller.common.mws.model.GetFeedSubmissionResultResult;
import com.rondaful.cloud.seller.common.mws.model.GetReportCountRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportCountResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportListByNextTokenRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportListByNextTokenResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportListRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportListResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequestCountRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequestCountResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequestListByNextTokenRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequestListByNextTokenResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequestListRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportRequestListResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportResult;
import com.rondaful.cloud.seller.common.mws.model.GetReportScheduleCountRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportScheduleCountResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportScheduleListByNextTokenRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportScheduleListByNextTokenResponse;
import com.rondaful.cloud.seller.common.mws.model.GetReportScheduleListRequest;
import com.rondaful.cloud.seller.common.mws.model.GetReportScheduleListResponse;
import com.rondaful.cloud.seller.common.mws.model.IdList;
import com.rondaful.cloud.seller.common.mws.model.ManageReportScheduleRequest;
import com.rondaful.cloud.seller.common.mws.model.ManageReportScheduleResponse;
...
import com.rondaful.cloud.seller.common.mws.model.ResponseHeaderMetadata;
import com.rondaful.cloud.seller.common.mws.model.ResponseMetadata;
import com.rondaful.cloud.seller.common.mws.model.StatusList;
...
import com.rondaful.cloud.seller.common.mws.model.UpdateReportAcknowledgementsRequest;
import com.rondaful.cloud.seller.common.mws.model.UpdateReportAcknowledgementsResponse;
 ...
 *
 */
public  class MarketplaceWebServiceClientMy implements MarketplaceWebService {
    ...
    static {
        try {
            jaxbContext = JAXBContext.newInstance("com.rondaful.cloud.seller.common.mws.model", MarketplaceWebService.class.getClassLoader());
     ...
     */
    public  MarketplaceWebServiceClientMy(
     ...
     */
    public GetReportResponse getReport(GetReportRequest request, JSONObject obj) throws MarketplaceWebServiceException {
        return invoke(GetReportResponse.class, convertGetReport(request), request,obj);
    }

    @Override
    public GetReportResponse getReport(GetReportRequest request) throws MarketplaceWebServiceException {
        return getReport(request,null);
    }
    ...
    public SubmitFeedResponse submitFeed(SubmitFeedRequest request) throws MarketplaceWebServiceException {
        return invoke(SubmitFeedResponse.class, convertSubmitFeed(request), request,null);
    }
    ...
    public GetFeedSubmissionResultResponse getFeedSubmissionResult(GetFeedSubmissionResultRequest request) throws MarketplaceWebServiceException {
        return invoke(GetFeedSubmissionResultResponse.class, convertGetFeedSubmissionResult(request), request,null);
    }
     ...
     */
    private void copyResponseToOutputStream(InputStream from, OutputStream to,String charSet) throws IOException {
     ...
     * Stream the response into an output stream.
     */
    private void copyResponseToOutputStream2(InputStream from, OutputStream to,String charSet) throws IOException {

        InputStreamReader inputStreamReader = new InputStreamReader(from,charSet);
        BufferedReader bf = new BufferedReader(inputStreamReader);
        String str;
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(to);
    ...
    private <T> T invoke(Class<T> clazz, Map<String, String> parameters)
            throws MarketplaceWebServiceException {
        return invoke( clazz, parameters, null ,null);
    }

    @SuppressWarnings("serial")
    private <T, U> T invoke(Class<T> clazz, Map<String, String> parameters, U request ,JSONObject obj) throws MarketplaceWebServiceException {
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    if (status == HttpStatus.SC_OK && responseBodyString != null) {
                        ...
                        NameValuePair parameter = element.getParameter(0);
                        String charSet = parameter.getValue();
                        obj.put("charSet",charSet);
                        copyResponseToOutputStream(postResponse.getEntity().getContent(), os,charSet);
                        os.close();
                        originalOs.close();
                        ...
                        //copyResponseToOutputStream2(postResponse.getEntity().getContent(), os,charSet);
                        ...
                        if (status == HttpStatus.SC_INTERNAL_SERVER_ERROR
                            ...
                            com.rondaful.cloud.seller.common.mws.model.Error error = errorResponse.getError().get(0);
            ...
            log.debug("MarketplaceWebServiceException info: "+JSON.toJSONString(se));
    ...
    private void addRequiredParametersToRequest(HttpPost method, Map<String, String> parameters)
        ...
        //method.setEntity(new UrlEncodedFormEntity(parameterList, HTTP.ISO_8859_1));
