...
public class ValidatorUtil {
    ...
    public static final String ALPHANUMERICCHINESE = "[1-9A-Za-z\\u4e00-\\u9fa5]{1,100}";//字母数字汉字
     ...
     * 字母数字汉字
     *
     * @param alphanumericChinese
     * @return
     */
    public static boolean isAlphanumericChinese(String alphanumericChinese) {
        return Pattern.matches(ALPHANUMERICCHINESE, alphanumericChinese);
    }

    public static void main(String[] args) {
      System.out.println(isAlphanumericChinese("电饭锅"));
    }
