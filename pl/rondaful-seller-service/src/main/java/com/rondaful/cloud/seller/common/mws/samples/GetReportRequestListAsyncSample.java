...
//EU
        ...
        requestOne.setMerchant( "ATI07IPDV06S6" );
        ArrayList<String> strings = new ArrayList<>();
         strings.add("54961018008");  //15848834216018005
         //strings.add("55095018002");
         //strings.add("11111111111");
        IdList idList = new IdList(strings);
        requestOne.setReportRequestIdList(idList);
        requestOne.setMWSAuthToken("amzn.mws.38b44e73-05c6-aaa8-1abb-3f6962eb4d04");
