...
import com.rondaful.cloud.seller.common.mws.model.SubmitFeedResult;
...
public class SubmitFeedSample {
    ...
    public static void main(String... args) throws FileNotFoundException {
         ...
         ***********************************************************************/
        final String merchantId =KeyValueConts.merchantId; // "<Your Merchant ID>";
        ...
        String md5;
		try {
			md5 = new AmazonContentMD5().computeContentMD5HeaderValue(new FileInputStream(filePath));
