 ...
 * */
@Component
public class SupplierServiceFallbackProvider implements ZuulFallbackProvider {

    @Override
    public String getRoute() {
        return "rondaful-supplier-service";
    }
    ...
    public ClientHttpResponse fallbackResponse() {
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                Utils.print(JSONObject.fromObject(new Massage("100500", "供应商服务异常")));
                return null;
            }
