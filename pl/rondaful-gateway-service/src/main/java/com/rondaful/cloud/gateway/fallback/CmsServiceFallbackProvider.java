 ...
 * */
@Component
public class CmsServiceFallbackProvider implements ZuulFallbackProvider {

    @Override
    public String getRoute() {
        return "rondaful-cms-service";
    }
    ...
    public ClientHttpResponse fallbackResponse() {
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                Utils.print(JSONObject.fromObject(new Massage("100500", "后台管理服务异常")));
                return null;
            }
