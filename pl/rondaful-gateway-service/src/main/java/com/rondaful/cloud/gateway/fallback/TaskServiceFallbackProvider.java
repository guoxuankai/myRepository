 ...
 * */
@Component
public class TaskServiceFallbackProvider implements ZuulFallbackProvider {

    @Override
    public String getRoute() {
        return "rondaful-task-service";
    }
    ...
    public ClientHttpResponse fallbackResponse() {
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                Utils.print(JSONObject.fromObject(new Massage("100500", "任务调度服务异常")));
                return null;
            }
