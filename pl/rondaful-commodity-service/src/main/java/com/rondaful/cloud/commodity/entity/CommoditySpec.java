...
public class CommoditySpec implements Serializable {
    ...
    @ApiModelProperty(value = "sku刊登数")
    private Integer publishNum;
    
    @ApiModelProperty(value = "是否侵权，1：是，0：否")
    private Integer tortFlag;
    
    @ApiModelProperty(value = "仓库ID组合，es查询用")
    private String warehouseIds;
   
    //@ApiModelProperty(value = "sku仓库相关信息")
    private List<SkuInventoryVo> inventoryList;
    
    @ApiModelProperty(value = "多仓库价格(USD)")
    private String warehousePriceGroup;
    
    @ApiModelProperty(value = "多仓库价格(RMB)")
    private String warehousePriceGroupRmb;
    
    //可售卖家ID
    private List<String> sellerIds;
    
    //演示用库存
    private int inventoryPlay;
    
    @ApiModelProperty(value = "sku仓库价格等信息")
    private List<SkuWarehouseInfo> skuWarehouseInfoList;
	...
	public List<SkuInventoryVo> getInventoryList() {
		return inventoryList;
	}

	public void setInventoryList(List<SkuInventoryVo> inventoryList) {
	...
	public String getWarehousePriceGroupRmb() {
		return warehousePriceGroupRmb;
	}

	public void setWarehousePriceGroupRmb(String warehousePriceGroupRmb) {
		this.warehousePriceGroupRmb = warehousePriceGroupRmb;
	}

	public int getInventoryPlay() {
		return inventoryPlay;
	}

	public void setInventoryPlay(int inventoryPlay) {
		this.inventoryPlay = inventoryPlay;
	}
	...
	public List<SkuWarehouseInfo> getSkuWarehouseInfoList() {
		return skuWarehouseInfoList;
	}

	public void setSkuWarehouseInfoList(List<SkuWarehouseInfo> skuWarehouseInfoList) {
