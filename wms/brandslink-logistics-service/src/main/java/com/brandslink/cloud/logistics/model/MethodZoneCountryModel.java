 ...
 */
@Data
@ApiModel(value = "MethodZoneCountryModel")
public class MethodZoneCountryModel implements Serializable {
    ...
    private List<CountryRemoteFeeModel> remoteList = new ArrayList<>();
