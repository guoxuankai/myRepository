...
import com.brandslink.cloud.logistics.VO.MethodZoneCountryVO;
 ...
 */
@Data
@ApiModel(value = "MethodZoneFreightVO")
public class MethodZoneFreightVO extends BaseEntity implements Serializable {
    ...
    private List<MethodZoneCountryVO> zoneCountryList = new ArrayList<>();
